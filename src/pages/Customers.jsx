...
const Customers = () => {
  return (
    ...
    <GridComponent id="gridcomp" dataSource={ customersData} allowPaging allowSorting allowPdfExport={true} toolbar={["Delete"]} editSettings={{allowDeleting:true,allowEditing:true}} width="auto">
